...
**Heuristic active site detection**: Automatically identifies the consensus active-site column by using ASLIGNED sequences, sampling the initial subset of the alignment.
